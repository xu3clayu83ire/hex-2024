...
const data1 = ref([
    {
        ...
        description: '全新嗅覺體驗，花香四溢、明亮馥郁。結合茉莉、依蘭依蘭、橙花和最迷人的格拉斯晚香玉之花香，呈現出夢幻花香氣息。 極具女性特質的香奈兒嘉柏麗香水，專為光芒四射的她而生。'
    },
    {
        id: 2,
        imageUrl: img2,
        title: 'Five O’clock Au Gingembre',
        description: '生薑與溫醇的肉桂香、紅糖的香甜摻和成一氣，溫暖微辛的氣息反倒形成一股輕煙氤氳開來，還帶點微微煙醺感漫溢在整個鼻息之間，細聞之下,又還有溫溫淡淡的木香，溫和而暖心。'
    },
    {
        id: 3,
        imageUrl: img3,
...
<template>
    <section class="section1 mt-9 mt-lg-13 container">
        <ul class="row row-gap-7 row-gap-lg-0">
            <li v-for=" data in data1" :key="data.id" class="col-12 col-lg-9">
                <ItemType1 :data="data" />
            </li>
                ...
                <div class="row">
                    <div class="col-12 col-lg-6 px-0">
                        <div class="text-center">
                            <img class="img-type2" :src="img4" alt="" />
                        </div>
                    </div>
                    <div class="col align-items-center d-flex justify-content-center">
                        <ul class="text-area mt-1 mt-lg-0">
                            ...
                            <li class="mt-10">
                                <button class="btn btn-outline-dark rounded-5 fs-5 border-2 px-11">Plan a free online
                                    training</button>
                            </li>
                        </ul>
                    </div>
